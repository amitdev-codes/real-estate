...
class StoreProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            "slug" => "required|regex:/^[a-z0-9-]+$/|string|max:255|unique:projects",
            ...
            "lowest_price" => "nullable|integer|min:1",
            "max_price" => "nullable|integer|min:1|gte:lowest_price",
            ...
            "developer_email" => "required_without:developer_id|nullable|email|unique:property_developers,developer_email",
