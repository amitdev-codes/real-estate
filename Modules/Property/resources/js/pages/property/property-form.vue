      ...
      <FormElements>
        <GroupElement name="title_section" class="group-element-container">
          ...
          <TextElement
            ...
            label="Slug"
            :columns="{ default: 12, sm: 6 }"
            rules="required|max:255|min:5|regex:/^[a-z0-9-]+$/"
          />
          <TextareaElement
        ...
        >
          ...
          <TextElement
            ...
            input-type="number"
            :columns="{ default: 12, sm: 6 }"
            rules="required|numeric|gt:details_section.offer_price"
          />
          <TextElement
            name="offer_price"
            label="Offer Price"
            input-type="number"
            :columns="{ default: 12, sm: 6 }"
            rules="required|numeric|lt:details_section.base_price"
          />
        </GroupElement>
        ...
        >
          ...
          <StaticElement
            name="h2_property_type_and_features"
            content="Property Type and Features"
            tag="h5"
            class="text-gray-500"
          />
          <StaticElement
        ...
        >
          ...
          <DateElement name="publish_start_date" label="Publish Start Date" :columns="{container:6}"/>
          <DateElement name="publish_end_date" label="Publish End Date" :columns="{container:6}"/>
...
const breadcrumbs = ref([
  { name: "Property", route: "admin.properties.index" },
]);
...
const rentingStatusId = computed(() => {
  return props.propertyStatus.find(
...
const fillValues = () => {
  ...
  if (props.property) {
    ...
    // Address section
    formValues.country = "Australia"; // Default value
    ...
    // category_id is a required field
    formValues.category_id = props.property.category_id || null;
    ...
    formValues.hero_image = props.property.hero_image_path || null;
    formValues.image_360 = props.property.image_360_path || null;
    formValues.floor_plan_images = props.property.floor_plan_image_path || [];
    formValues.property_gallery = props.property.gallery_image_path || [];
    ...
    formValues.seo_description =
      props.property.meta_content?.seo_description || "";
    formValues.seo_indexing = props.property.meta_content?.seo_indexing || 0;
    formValues.seo_image = props.property.meta_content?.image_path || null;

    formValues.agent_id = props.property.agent_id || null;
    formValues.moderation_status = props.property.moderation_status || null;
