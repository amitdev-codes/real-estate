<template>
    ...
    <div id="hs-bg-gray-on-hover-cards" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-bg-gray-on-hover-cards-label">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-4xl sm:w-full m-3 h-[calc(100%-3.5rem)] sm:mx-auto">
        ...
        <div class="p-4 overflow-y-auto">
            ...
            <div class="py-3 sm:py-6">
                <h4 class="mb-2 text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">
                Base
                </h4>
                ...
                <!-- Card -->
                <a class="bg-white p-4 transition duration-300 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="../docs/frameworks-vuejs.html">
                    <div class="flex gap-x-6">
                    <div class="mt-1.5 flex justify-center shrink-0 rounded-s-xl">
                        <svg class="size-5 text-gray-800 dark:text-neutral-200" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a class="bg-white p-4 transition duration-300 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="../docs/frameworks-vuejs.html">
                    <div class="flex gap-x-6">
                    <div class="mt-1.5 flex justify-center shrink-0 rounded-s-xl">
                        <svg class="size-5 text-gray-800 dark:text-neutral-200" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <a class="bg-white p-4 transition duration-300 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="../docs/frameworks-vuejs.html">
                    ...
                    <div class="grow">
                        <h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">
                        Mega Menu <span class="ms-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/70 dark:border-blue-700 dark:text-blue-500">Hot</span>
                        </h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-500">
                        A framework for building web user interfaces.
                        </p>
            ...
            <div class="py-3 sm:py-6">
                ...
                <a class="bg-white p-4 transition duration-300 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="../docs/frameworks-vuejs.html">
                    ...
                    <div class="grow">
                        <h3 class="text-sm font-semibold text-blue-600 dark:text-blue-500">
                        Sidebar <span class="ms-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/70 dark:border-blue-700 dark:text-blue-500">New</span>
                        </h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-500">
                        A framework for building web user interfaces.
                        </p>
                ...
                Completely unstyled, fully accessible UI <a class="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="../plugins.html">plugins</a> for popular features that for one reason or another don't belong in core.
                </p>
            </div>
            </div>
        </div>
