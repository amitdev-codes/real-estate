    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="flex-grow space-y-4">
                            <div class="space-y-4 bg-gray-50 p-4 rounded-lg h-fit">
                                ...
                                <p class="text-gray-600 text-sm flex items-center space-x-2">
                                    <span class="font-bold">License Number:</span>
                                    <span>{{ props.data?.license_number || "N/A" }}</span>
                                </p>
                                <p class="text-gray-600 text-sm flex items-center space-x-2">
            ...
            <StepperFormModal
                ...
                :steps="formSteps"
                :model-value="data"
                :submit-handler="(vueformData, form$) => handleSubmit(vueformData, form$, 'agents.update', props.data.id, () => showProfileEditor = false)"
                @close="showProfileEditor = false"
            >
                <template #default>
                    <BasicInfo :data="props.data" />
                    <Professional :data="props.data" :agencies="agencies" />
                    <ServiceAreas :data="props.data" />
...
const formSteps = [
    { name: "account", label: "Basic Info", elements: ["basic_info", "first_name", "last_name", "email", "phone"] },
    { name: "personal", label: "Professional", elements: ["license_number", "experience", "agency_id", "professional"] },
    { name: "service_areas", label: "Service Areas", elements: ["service_areas", "primary_area", "additional_areas"] },
    { name: "bio_photo", label: "Bio Photo", elements: ["bio_photo", "image", "short_description", "specializations"] },
];
...
const completionItems = ref([
    ...
    { text: "License Information", completed: computed(() => !!props.data?.license_number) },
    { text: "Service Areas", completed: computed(() => !!props.data?.primary_area?.length) },
]);
