...
Route::middleware('guest')->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::post('login', [AuthenticatedSessionController::class, 'adminLogin'])->name('admin.login-post');
...
Route::middleware('auth')->group(function () {
    ...
    // Apply the prefix based on role

        // Route::get('notifications', [NotificationController::class, 'index'])->name('notifications.index');
        // Route::get('notifications/{id}', [NotificationController::class, 'viewNotifications'])->name('notifications.view');
        // Route::delete('notifications/bulk-delete', [NotificationController::class, 'bulkDelete'])->name('notifications.bulk-delete');

        // Route::get('notification-groups', [NotificationController::class, 'getGroups']);
        ...
        // Route::post('notifications/bulk-mark-as-read', [NotificationController::class, 'bulkMarkAsRead'])->name('notifications.bulk-read');
