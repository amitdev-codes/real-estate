                ...
                <div class="p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                    <div class="text-center">
                        <img src="@backend-assets/images/client/07.jpg"
                            class="mx-auto h-20 w-20 rounded-full shadow dark:shadow-gray-800" alt="">
                    ...
                    <form action="/profile">
                        <div class="grid grid-cols-1">
                            ...
                            <div class="flex justify-between mb-4">
                                ...
                                <p class="text-slate-400 mb-0"><Link :href="route('admin.backend.reset-password')"
                                        class="text-slate-400">Forgot password ?</Link></p>
                            </div>
