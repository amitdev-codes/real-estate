                    ...
                    <div class="lg:w-2/5">
                        <div class="relative overflow-hidden rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                            ...
                            <div class="px-6 py-12 text-center">
                                ...
                                <div class="mt-6">
                                    <Link :href="route('admin.dashboard')" class="btn bg-green-600 hover:bg-green-700 border-green-600 hover:border-greenbg-green-700 text-white rounded-md">Continue</Link>
                                </div>
                            </div>

                            <div class="text-center p-6 border-t border-gray-100 dark:border-gray-700">
                                <p class="mb-0 text-slate-400 font-medium">© {{date}} Hously. Design with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
