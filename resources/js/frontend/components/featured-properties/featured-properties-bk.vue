<template>
        ...
        <div v-if="featureds"  :class="featuredgrid">
            <div v-for="item in datas" :key="item"
                class="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                <div class="relative">
                    <img :src="item.hero_image_path" :alt="item.title">
                ...
                <div class="p-6">
                    <div class="pb-6">
                        ...
                        <Link :href="route('frontend.property-detail-two')"
                            class="text-lg hover:text-green-600 font-medium ease-in-out duration-500">{{ item.title}}
                        </Link>
                    </div>
                    ...
                    <ul class="pt-6 flex justify-between items-center list-none">
                        <li>
                            ...
                            <a href="" class="text-slate-400">{{ item.project?.name }}</a>
