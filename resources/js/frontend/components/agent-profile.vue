        ...
        <div class="grid grid-cols-1">
            <div class="p-6 rounded-md bg-green-600/10 dark:bg-green-600/20">
                <div class="md:flex items-center">
                    <img :src="image" class="rounded-full size-28" alt="">

                    <div class="md:ms-4 md:mt-0 mt-4 md:flex justify-between items-end">
                        <div>
                            <h5 class="text-2xl font-medium">{{data?.name ? data?.name :'Amber Durden'}}
                                <span class="text-base md:inline block md:mt-0 mt-2">
                                    <span class="text-slate-400">
                                        ...
                                        Broker</span> of
                                        <Link :href="route('frontend.agency-profile')" class="hover:text-green-600">Highrises Realty</Link>
                                </span>
                            </h5>
                                ...
                                <li class="md:inline-flex flex items-center md:mx-2 md:mt-0 mt-2 md:px-2">
                                    <ul class="list-none">
                                        <li class="inline me-1">
                                            <a href="" class="btn btn-icon btn-sm border border-gray-300 dark:border-gray-400 rounded-md text-slate-400 hover:border-green-600 hover:text-white hover:bg-green-600 dark:hover:border-green-600">
    ...
    <div class="container relative mt-6">
        <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            ...
            <div class="lg:col-span-8 md:col-span-7 order-1 md:order-2">
                ...
                <featureds :featureds=true :featuredgrid="'grid lg:grid-cols-2 grid-cols-1 mt-4 gap-[30px]'" />

                <div class="md:flex justify-center text-center mt-6">
                    <div class="md:w-full">
                        <Link :href="route('frontend.grid')"
...
<script setup>
import featureds from '@/frontend/components/featured-properties/featured-properties.vue';
// import { useRoute } from 'vue-router';
import image from '@frontend-assets/images/client/03.jpg'
