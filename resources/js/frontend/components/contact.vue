    ...
    <div class="container relative">
        <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            <div class="lg:col-span-7 md:col-span-6">
                <img src="@frontend-assets/images/svg/contact.svg" alt="">
            </div>
            ...
            <div v-for="item in datas" :key="item" class="text-center px-6">
                ...
                <div class="content mt-7">
                    ...
                    <div class="mt-5">
                        <a :href="item.link"
                            data-type="iframe"
                            class="video-play-icon read-more lightbox btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">{{item.title}}</a>
                    </div>
                </div>
            </div>
        </div><!--end grid-->
