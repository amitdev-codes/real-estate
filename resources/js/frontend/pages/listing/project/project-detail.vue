<template>
            ...
            <div class="md:flex mt-4">
                <div class="lg:w-1/2 md:w-1/2 p-1">
                    <div class="group relative overflow-hidden">
                        <img  src="@frontend-assets/images/property/single/1.jpg" alt="">
                ...
                <div class="lg:w-1/2 md:w-1/2">
                    <div class="flex">
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden">
                                <img src="@frontend-assets/images/property/single/2.jpg" alt="">
                        ...
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden">
                                <img src="@frontend-assets/images/property/single/3.jpg" alt="">
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out">
                                </div>
                                <div
                                    class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                    ...
                    <div class="flex">
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden">
                                <img src="@frontend-assets/images/property/single/4.jpg" alt="">
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out">
                                </div>
                                <div
                                    class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                        ...
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden">
                                <img src="@frontend-assets/images/property/single/5.jpg" alt="">
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out">
                                </div>
                                <div
                                    class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
    ...
    <!-- End Hero -->
    <VueEasyLightbox :visible="visibleRef" :imgs="imgsRef" :index="indexRef" @hide="onHide"></VueEasyLightbox>
</template>

<script setup>
import { ref, onMounted } from 'vue'
import VueEasyLightbox from 'vue-easy-lightbox';
import image from '@frontend-assets/images/property/single/1.jpg'
import image2 from '@frontend-assets/images/property/single/2.jpg'
import image3 from '@frontend-assets/images/property/single/3.jpg'
import image4 from '@frontend-assets/images/property/single/4.jpg'
import image5 from '@frontend-assets/images/property/single/5.jpg'
...
function getImage(fileName){
    return new URL(`/resources/assets/frontend/images/property/${fileName}`, import.meta.url).href;
}
